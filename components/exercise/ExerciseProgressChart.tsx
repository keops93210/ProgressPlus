...
const styles=StyleSheet.create({card:{marginHorizontal:16,marginBottom:16,padding:18,borderRadius:22,borderWidth:1,borderColor:Colors.border,backgroundColor:Colors.surface},header:{flexDirection:"row",alignItems:"center",justifyContent:"space-between"},eyebrow:{color:Colors.primary,fontSize:10,fontWeight:"900",letterSpacing:1.2},title:{color:Colors.text,fontSize:19,fontWeight:"900",marginTop:4},change:{fontSize:16,fontWeight:"900"},row:{flexDirection:"row",gap:7,marginTop:12},pill:{paddingHorizontal:10,paddingVertical:7,borderRadius:13,backgroundColor:Colors.surfaceLight},pillActive:{backgroundColor:Colors.primary},pillText:{color:Colors.textSecondary,fontSize:11,fontWeight:"800"},pillTextActive:{color:Colors.textOnPrimary},metricActive:{backgroundColor:Colors.primarySoft},metricTextActive:{color:Colors.primaryLight},insight:{flexDirection:"row",justifyContent:"space-between",marginTop:15,padding:12,borderRadius:15,backgroundColor:Colors.surfaceLight},label:{color:Colors.textMuted,fontSize:8,fontWeight:"900",letterSpacing:.7},insightValue:{color:Colors.text,fontSize:12,fontWeight:"900",marginTop:3},chart:{height:170,marginTop:18,flexDirection:"row",alignItems:"flex-end",justifyContent:"space-between",gap:5},column:{flex:1,height:"100%",alignItems:"center",justifyContent:"flex-end"},value:{color:Colors.textSecondary,fontSize:8,fontWeight:"800",marginBottom:5},track:{height:112,width:"72%",justifyContent:"flex-end",backgroundColor:Colors.surfaceLight,borderRadius:8,overflow:"hidden"},bar:{width:"100%",backgroundColor:Colors.primary,borderRadius:8},bestBar:{backgroundColor:Colors.success},date:{color:Colors.textMuted,fontSize:8,marginTop:6},summary:{color:Colors.textSecondary,fontSize:13,lineHeight:19,marginTop:14},loading:{color:Colors.textSecondary,textAlign:"center",marginTop:8},empty:{color:Colors.textSecondary,fontSize:13,lineHeight:20,marginTop:4}});

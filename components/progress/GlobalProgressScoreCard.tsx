...
export function GlobalProgressScoreCard({ input }: Props) {
  ...
  const confidence = Math.round((available / 4) * 100);
  return (
    <View style={styles.card}>
      <View style={styles.header}>
        <View style={styles.copy}><Text style={styles.eyebrow}>PROGRESS+ SCORE</Text><Text style={styles.title}>Ta progression globale</Text></View>
      ...
      <View style={styles.confidence}><Text style={styles.helper}>{available}/4 indicateurs disponibles</Text><Text style={styles.confidenceValue}>Confiance {confidence}%</Text></View>
    </View>
  );
}

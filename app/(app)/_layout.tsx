...
export default function AppLayout() {
  return (
    <Tabs screenOptions={{ headerShown: false, tabBarActiveTintColor: Colors.primary, tabBarInactiveTintColor: "#6B7280", tabBarStyle: { backgroundColor: Colors.surface, borderTopWidth: 0, height: 78, paddingTop: 10, paddingBottom: 12 } }}>

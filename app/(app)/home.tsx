...
const styles = StyleSheet.create({
  ...
  levelXp: { color: Colors.primaryLight, fontSize: 20, fontWeight: "900", position: "absolute", right: 15, top: 14 },
  levelTrack: { position: "absolute", left: 15, right: 15, bottom: 12, height: 5, borderRadius: 3, backgroundColor: "#292832", overflow: "hidden" },
  levelFill: { height: "100%", borderRadius: 3, backgroundColor: Colors.primary },
  scoreHeading: { flexDirection: "row", alignItems: "flex-end", justifyContent: "space-between", marginTop: 3 },
  sectionKicker: { color: Colors.primaryLight, fontSize: 8, fontWeight: "900", letterSpacing: 1.4 },
  sectionTitle: { color: "#FFFFFF", fontSize: 17, fontWeight: "900", letterSpacing: -0.2 },
  seeMore: { color: Colors.primaryLight, fontSize: 11, fontWeight: "800" },
  sectionHeader: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", marginTop: 3 },
  sectionAction: { color: Colors.primaryLight, fontSize: 11, fontWeight: "800" },
  weekHeader: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", marginTop: 2 },
  weekGrid: { flexDirection: "row", gap: 10 },
  rankMini: { flex: 0.8, minHeight: 112, backgroundColor: "#111116", borderRadius: 18, borderWidth: 1, borderColor: "#272631", padding: 14 },
  rankMiniValue: { color: "#FFFFFF", fontSize: 24, fontWeight: "900", marginTop: 10 },
  rankMiniLabel: { color: "#7F7F8B", fontSize: 10, marginTop: 2 },
  coachCard: { backgroundColor: "#111116", borderRadius: 20, padding: 15, borderWidth: 1, borderColor: "#2A2834", flexDirection: "row" },
  ...
  coachMessage: { color: "#858591", fontSize: 11, lineHeight: 17, marginTop: 4 },
  coachAction: { fontSize: 11, fontWeight: "900", marginTop: 8 },
  performanceCard: { backgroundColor: "#111116", borderRadius: 20, borderWidth: 1, borderColor: "#272631", padding: 16 },
  performanceHero: { flexDirection: "row", alignItems: "center", justifyContent: "space-between" },
  performanceKicker: { color: "#7F7F8B", fontSize: 8, fontWeight: "900", letterSpacing: 1.2 },
  performanceValue: { color: "#FFFFFF", fontSize: 25, fontWeight: "900", marginTop: 3 },
  performanceTrend: { fontSize: 10, fontWeight: "800", marginTop: 3 },
  performanceBadge: { width: 58, height: 58, borderRadius: 16, backgroundColor: "#1B1430", borderWidth: 1, borderColor: "#49317C", alignItems: "center", justifyContent: "center" },
  performanceBadgeValue: { color: Colors.primaryLight, fontSize: 20, fontWeight: "900" },
  performanceBadgeLabel: { color: "#888694", fontSize: 8 },
  miniChart: { height: 75, marginTop: 15, flexDirection: "row", alignItems: "flex-end", justifyContent: "space-around", borderBottomWidth: 1, borderBottomColor: "#282731" },
  bar: { width: 18, borderTopLeftRadius: 5, borderTopRightRadius: 5, backgroundColor: Colors.primary },
  chartLabels: { flexDirection: "row", justifyContent: "space-around", marginTop: 5 },
  recoveryHeader: { flexDirection: "row", alignItems: "center", justifyContent: "space-between" },
  recoveryScore: { color: Colors.primaryLight, fontSize: 13, fontWeight: "900" },
  recoveryCard: { backgroundColor: "#111116", borderRadius: 18, borderWidth: 1, borderColor: "#272631", flexDirection: "row", alignItems: "stretch", paddingVertical: 15 },
  metric: { flex: 1, alignItems: "center", gap: 4 },
  metricValue: { color: "#FFFFFF", fontSize: 17, fontWeight: "900" },
  metricLabel: { color: "#7F7F8B", fontSize: 10 },
  divider: { width: 1, backgroundColor: "#292832" },
  recordCard: { backgroundColor: "#111116", borderRadius: 18, borderWidth: 1, borderColor: "#272631", padding: 15, flexDirection: "row", alignItems: "center" },
  recordIcon: { width: 40, height: 40, borderRadius: 12, backgroundColor: "#21143C", alignItems: "center", justifyContent: "center", marginRight: 11 },
  recordExercise: { color: "#FFFFFF", fontSize: 15, fontWeight: "900" },
  recordDate: { color: "#7F7F8B", fontSize: 10, marginTop: 3 },
  recordValue: { color: Colors.success, fontSize: 18, fontWeight: "900", marginLeft: 8 },
  emptyRecord: { backgroundColor: "#111116", borderRadius: 18, borderWidth: 1, borderColor: "#272631", padding: 15, flexDirection: "row", alignItems: "center", gap: 10 },
  emptyRecordText: { color: "#858591", flex: 1, fontSize: 11, lineHeight: 17 },
